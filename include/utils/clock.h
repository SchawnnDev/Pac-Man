...
#include <chrono>
    ...
    public:
        ...
        [[nodiscard]] inline uint64_t frame_count() const noexcept
        { return m_frame_count; }

        [[nodiscard]] inline double since_start() const noexcept
        { return to_seconds(source_clock::now() - m_start); }

        [[nodiscard]] inline double last_delta() const noexcept
        { return to_seconds(m_last_delta); }
